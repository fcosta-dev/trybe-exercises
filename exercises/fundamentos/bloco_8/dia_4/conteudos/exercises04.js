...
const getMelhorMateria = (acumulador, materia) => {
...
function alunoMateria () {
  return estudantes
  .map((elemento) => ({name: elemento.nome, materia: elemento.materias.reduce(getMelhorMateria).name}));
}
console.log(alunoMateria())